...
namespace AgriculturePresentation.ViewComponents
{
    ...
    {
        AgricultureeContext c = new AgricultureeContext();
        public IViewComponentResult Invoke()
        {
            ...
            ViewBag.announcementTrue = c.NewsAnnoucs.Where(x => x.Status == true).Count();
            ViewBag.announcementFalse = c.NewsAnnoucs.Where(x => x.Status == false).Count();
