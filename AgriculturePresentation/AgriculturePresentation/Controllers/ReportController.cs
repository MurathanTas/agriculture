...
namespace AgriculturePresentation.Controllers
{
    public class ReportController : Controller
    {
        ...
        public List<NewsAnnoucModel> AnnouncementList()
        {
            List<NewsAnnoucModel> announcementModels = new List<NewsAnnoucModel>();
            using (var context = new AgricultureeContext())
            {
                announcementModels = context.NewsAnnoucs.Select(x => new NewsAnnoucModel
                {
                    Id = x.NewsAnnoucId,
                    Status = x.Status,
                    Date = x.Date,
